...
Meanwhile, across the Narrow Sea, Prince Viserys, heir of the fallen House Targaryen, which once ruled all of Westeros, schemes to reclaim the throne with an army of barbarian Dothraki—whose loyalty he will purchase in the only coin left to him: his beautiful yet innocent sister, Daenerys.`,
  ...
  },
  {
    ...
    description: `THE BOOK BEHIND THE SECOND SEASON OF GAME OF THRONES, AN ORIGINAL SERIES NOW ON HBO.
...
This 10th edition contains new information that highlight various technological updates in recent years, providing you with highly relevant and current information. With new case studies and updated chapters on topics like service-oriented software, this edition ensures your studies keep pace with today's business world.`,
  ...
  },
  {
    ...
    author: "Mark J. Price",
    cover: "/books/Csharp 7 and dotNET Core book cover.jpg",
    description: `C# 7 - новая мощная и многофункциональная версия популярнейшего языка программирования от Майкрософт. Вы встретите немало интересных книг по языку C# и платформе .NET, однако, в большинстве из них лишь мельком рассматривается столь важный аспект, как кросс-платформенная разработка. Научитесь писать приложения, которые работают всегда и везде, на ПК и мобильных устройствах. Познакомьтесь с инструментом Xamarin.Forms, освойте тонкости работы с Visual Studio 2017, добейтесь многогранности и универсальности ваших программ на C#. 3-е издание.`,
    publishedDate: "2018-01-01T12:00:00.000Z",
